...
?>
    <?php                     
    $res = Database::GetData("SELECT * FROM thuchienspnckh, giangvien, sanphamnckh WHERE thuchienspnckh.MaGV=giangvien.MaGV AND thuchienspnckh.MaSP = sanphamnckh.MaSP AND Username='" . $_SESSION["user"] . "'");
?>
    <div class="container">
        <div class="card">
