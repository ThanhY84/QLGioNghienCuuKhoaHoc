...
<div class="container">
    <?php
     if(isset($_POST)) {
        ...
        $sql = "insert into thuchienhdnckh values ('$tsnguoi','$thutu','$manh','$magv','$mahd','$trangthai','$id','$user','$gio','$tgnghiemthu','$minhchung', '$tenhoatdong')";
        if(Database::NonQuery($sql)) {
            echo 'Thêm thành công';
        }
    }
    ?>
    <h3 style="color:red"><i class="fa-solid fa-calendar-plus" style='font-size:25px;color:red'></i> KÊ KHAI GIỜ NGHIÊN CỨU KHOA HỌC BẰNG HOẠT ĐỘNG NGHIÊN CỨU KHOA HỌC</h3>
    <form method="POST">
